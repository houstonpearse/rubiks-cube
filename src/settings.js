...
export default class Settings {
    ...
    setPieceGap(value) {
        ...
        console.warn(`Invalid pieceGap value. Min is ${minGap}`);
    }

    /** @param {string} value in ms */
    ...
    setCameraRadius(value) {
        var speed = Number(value);
        if (speed >= 0) {
            this.cameraRadius = speed;
            return;
        }
        console.warn(`Invalid camera radius value. Min is 0. Value is ${value}`);
    }
