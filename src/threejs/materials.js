...
export default class Materials {
    static front = new MeshStandardMaterial({
        ...
        metalness: 0,
        roughness: 0.4,
        userData: { face: { id: 'F', name: 'front' }, color: 'green' },
    });
    static back = new MeshStandardMaterial({
        color: 'blue',
        metalness: 0,
        roughness: 0.4,
        userData: { face: { id: 'B', name: 'back' }, color: 'blue' },
    });
    static up = new MeshStandardMaterial({
        color: 'white',
        metalness: 0,
        roughness: 0.4,
        userData: { face: { id: 'U', name: 'up' }, color: 'white' },
    });
    static down = new MeshStandardMaterial({
        color: 'yellow',
        metalness: 0,
        roughness: 0.4,
        userData: { face: { id: 'D', name: 'down' }, color: 'yellow' },
    });
    static left = new MeshStandardMaterial({
        color: '#fc9a05',
        metalness: 0,
        roughness: 0.4,
        userData: { face: { id: 'L', name: 'left' }, color: 'orange' },
    });
    static right = new MeshStandardMaterial({
        color: 'red',
        metalness: 0,
        roughness: 0.4,
        userData: { id: 'R', face: 'right', color: 'red' },
    });
